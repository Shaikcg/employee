package net.cg.springboot.controller;
...
import net.cg.springboot.exception.ResourceNotFoundException;
import net.cg.springboot.model.Employee;
import net.cg.springboot.repository.EmployeeRepository;
...
public class EmployeeController {
	...
	// get employee by search key
	@GetMapping("/employees/search/{searchkey}")
	public List<Employee> getEmployeeByKey(@PathVariable String searchkey) {
		return employeeRepository.search(searchkey);
	}
